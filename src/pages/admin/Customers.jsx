          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[#5E6B7A]">
                Manage registered customers, sellers, brands,
                orders and designs.
              </p>
                  ...
                  filteredCustomers.map((customer) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        ...
                        <span
                          className={`inline-flex px-2.5 py-1 rounded-full text-xs font-bold ${customer.role === "Seller"
              ...
              filteredCustomers.map((customer) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span
                      className={`shrink-0 inline-flex px-2.5 py-1 rounded-full text-xs font-bold ${customer.role === "Seller"
                          ? "bg-[#F0F7FF] text-[#005FCC]"
                          : "bg-[#EEF8F4] text-[#167A57]"
                        }`}
                    >
